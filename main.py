...
class UI():
    ...
    def show_result(self):
        ...
        if self.bool == True:
            ...
            self.result_label.config(text=f'rgb : {sensing_result} gps:{location_result}')
            self.play_failed()
